...
the geometric median in the Hilbert space of quantile functions.
...
- hists:
  ...
  a length-\\N\\ list of histograms (`"histogram"` objects) with
  identical `breaks`.
...
- L:
  ...
  number of quantile levels used to approximate the median (default:
...
- ...:
  ...
  :   logical; whether to show current iteration (default: `FALSE`).
